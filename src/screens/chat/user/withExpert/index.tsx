...
const WithExpertChatScreen = () => {
    ...
    function deleteConversationAlert() {
        Alert.alert('Notice', 'Are you sure you want to delete this conversation?', [
            // Thêm sự kiện xóa tin nhắn ở đây
    ...
    function shareEmotionDiaryAlert() {
        Alert.alert('Notice', 'Are you sure you want to allow this expert to see your Emotion Diary?', [
            {text: 'OK', onPress: () => console.log('OK Pressed')},
            {text: 'Cancel', onPress: () => console.log('Cancel pressed')},
        ]);
    }
    ...
    return (
        <SafeAreaView style={styles.container}>
                    ...
                    {viewVisible ? (
                        <View style={styles.optionsView}>
                            ...
                            <TouchableOpacity onPress={shareEmotionDiaryAlert}>
                                <Text style={styles.reportOptionsText}>Show Emotion Diary</Text>
                            </TouchableOpacity>
            ...
            <ScrollView>
                ...
                <AnotherMessage message="My name is Expert Screen" />

                <SelfMessage message="Woww" />

                <AnotherMessage message="Yeah, do you wanna go to explore me?" />

                <SelfMessage message="Hmmm, that is crazy" />
            </ScrollView>
...
export default WithExpertChatScreen;
